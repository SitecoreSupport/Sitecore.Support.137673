...
{
    public class DateField : Sitecore.Support.Forms.Mvc.ViewModels.ValuedFieldViewModel<string>
    {
        public object Day
        {
            get;
        ...
        protected void OnValueUpdated()
        {
            ...
            {
                DateTime dateTime = Sitecore.DateUtil.IsoDateToDateTime(this.Value);
